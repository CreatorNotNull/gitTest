...
<div id="container">
    ...
    <form id="form1" method="post" action="userActionRegister.action" enctype="multipart/form-data">
    <table class="reg" cellspacing="0px" cellpadding="0px">
      <tbody>
      <tr>
        <td class="a_r w15p"><label for="fname">真实姓名：</label></td>
				<td class="w500"><input name="userDTO.myName" id="fname" type="text" /></td>
  ...
  贵美的权利和义务
    ...
    4.因网上交易平台的特殊性，贵美没有义务对所有用户的注册资料、所有的交易行为以及与交易有关的其他事项进行事先审查。 	
      ...
      <tr>
        ...
        <td><input name="userDTO.loginName" id="sname" type="text" />（可包含 a-z、0-9 和下划线）</td>
      </tr>
      <tr>
        <td class="a_r"><label for="pass">密码：</label></td>
        <td><input name="userDTO.pass" id="pass" type="password" />（至少包含 6 个字符）</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="userDTO.email" id="email" type="text" />（必须包含 @  字符）</td>
      </tr>
      <tr>
        <td class="a_r"><label for="gender">性别：</label></td>
				<td>
					<input name="userDTO.sex" id="gender" class="b0" type="radio" value="男" checked="checked" />
    	    <img src="images/male.gif" alt="alt" />男&nbsp; 
    	    <input name="userDTO.sex" class="b0" type="radio" value="女" />
